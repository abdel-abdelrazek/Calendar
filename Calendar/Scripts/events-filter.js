$(function () {
    ...
    debounce('#txtEventSearch', 'input', 1000).subscribe(value => {

        $("#dvEventsList").load('/Events/AllEvents_DescriptionFilter/' + value);
    ...
    function debounce(el, event, time = 2000) {
        ...
        // map through the events an get the value of the input
